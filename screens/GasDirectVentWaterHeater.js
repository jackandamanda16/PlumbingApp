...
const GasDirectVentWaterHeater = () => {
    ...
    const fetchAIAdvice = async () => {
        try {
            ...
            const prompt = `Analyze this Gas Direct Vent Water Heater issue. Symptom: "${symptom}". Model/Serial: "${modelSerial}". Provide detailed repair advice based on the image and inputs.`;
    ...
    return (
        <ScrollView style={styles.scrollContainer}>
            <View style={styles.contentContainer}>
                <Text style={styles.title}>Gas Direct Vent Water Heater Troubleshooting</Text>
                <TextInput
                    style={styles.input}
...
export default GasDirectVentWaterHeater;