...
const GasDirectVentWaterHeater = () => {
    ...
    const fetchAIAdvice = async () => {
        ...
        try {
            ...
            const prompt = `Analyze this Direct Vent Water Heater issue. Symptom: "${symptom}". Model/Serial: "${modelSerial}". Provide detailed repair advice based on the image and inputs.`;
