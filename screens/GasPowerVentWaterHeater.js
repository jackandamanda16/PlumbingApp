...
const GasPowerVentWaterHeater = () => {
    ...
    const fetchAIAdvice = async () => {
        ...
        try {
            ...
            const prompt = `Analyze this Gas Power Vent Water Heater issue. Symptom: "${symptom}". Model/Serial: "${modelSerial}". Provide detailed repair advice based on the image and inputs.`;
